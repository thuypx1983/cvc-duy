...
'travel-conference.php'=>'Voyages_Conferences/',
'travel-conference-detail.php'=>'Voyages_Conferences/',
...
include(PATH_APPLICATION.'nonsign.php');
 function urlBuild($file,$a=NULL,$hint=NULL){
	...
	if($file=='info.php'){
		return '/qui-sommes-nous/'.$a['url'].'.html';	
	}
	if(in_array($file, array('news-print.php','tour-print.php','hotel-print.php','service-print.php','service-detail.php','service-book.php','hotel-book.php','tour-book.php','hotel-detail.php','tour-detail.php','news-events-detail.php','travel-conference-detail.php','attraction-detail.php','useful-information-detail.php'))) {$urlrewriteext='.html';} else {$urlrewriteext='/';}
   // if($file == 'index.php')
       // return URL_BASE;
