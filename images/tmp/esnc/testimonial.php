...
@define('METADATA','/home/circuitvncambod/public_html/galatouriste-images/meta/testimonial.html');
...
<?php include PATH_COMPONENT.'box-flash.php' ?><body id="testimonial">
<div class="container">
    <div id="wrapper">
        <div class="top_content">
            ...
            <div class="clearfix" id="content">
                <div id="left_content">
                    <?php include '/home/circuitvncambod/public_html/component/testimonial.php';include '/home/circuitvncambod/public_html/component/box-social2.php' ?>
                </div>
