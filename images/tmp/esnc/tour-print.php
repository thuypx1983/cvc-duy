...
@define('METADATA','/home/circuitvncambod/public_html/galatouriste-images/meta/tour-print.html');
...
<body class="send_email_bd">
	<?php include '/home/circuitvncambod/public_html/component/tour-print.php';foreach(Esnc::$x_append as $value) echo $value;
