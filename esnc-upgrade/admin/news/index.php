...
class catnewslist extends folderlist{
	...
	function process(){
		...
		switch($this->act){
			...
			case ACT_SEARCH:
				...
				exit();
			case ACT_ADD:
				include_once('../../class/catnews.php');
				$item = new catnews;
...
$o = new catnewslist;
$o->type=$o->allowpaste=TABLE_NEWS;
$o->a_ctrl = &$CATNEWS_CTRL;//array of constants definition
$o->table='catnews';
$o->tbitem='news';
$o->flag=&$FOLDER_FLAG;
$o->alias='CN';
...
$o->doctitle="Qu&#7843;n tr&#7883; nh&oacute;m n&#7897;i dung";
$o->process();
