<?php    
    define('LM_APP_ID',         'fd60ba586e');
    define('LM_APP_SECRET',     '4ad30596d80496564427476ccadf5470e7888012');
    define('LM_URL',            'http://www.circuit-vietnam-cambodge.com');   
       ...
       function display(){                                                    
            ...
            if(count($db->links)){
				...
				foreach($db->links as $link){
					$str .='<a target="_blank" href="'.$link['link_url'].'">'.$link['link_anchortext'].'</a> | ';
					if($config['advert']) $str .= $link['link_desc'];
				}
				$layout .= substr($str,0,-2);
            }
